            ...
            <div id="navbar" className={this.state.scrolled ? "navbar scroll" : "navbar"}>
                ...
                <div className="navbar-about">
                    <div className="text-section">
                        ...
                        <p>
                            My <a href="https://purl.stanford.edu/ps366qr9397">research</a> has focused on language model memory, the ability of a model to learn from and remember a user's context and work. 
                            To this end, I've worked on the foundations ofinformation is stored in a language model's activations and parameters, focusing on the foundations of linear attention and loopeing, and multi-agent systems ()
